...
- Northern Ireland Legislative Assembly documents (SA102) — a P60/P45 for the Assembly office, an Office Cost Expenditure statement, or an expenses record for a member (MLA): populate "niAssembly" ONLY with what the document evidences. Pay from the P60 → "p60Pay" (and PAYE tax → "taxTakenOff"); Office Cost Expenditure → "officeCostExpenditure"; other cash reimbursements → "otherCashReimbursements"; other benefits → "allOtherBenefits"; balancing charges → "balancingCharges"; secretarial/clerical/research assistance the member paid → "secretarialAssistance"; office running costs paid → "officeExpenses"; other expenses and capital allowances → "otherExpensesCapitalAllowances". Leave every "niAssembly" field 0 if the document is not about an Assembly office. Only use this for the Northern Ireland Assembly — not for ordinary employment (use "employment") or a minister of religion.
- Members of Parliament documents (SA102 MPs) — a P60/P45 for a Westminster MP's office, an IPSA / Office Costs Expenditure statement, or an MP's benefits/expenses record: populate "parliament" ONLY with what the document evidences. Pay from the P60 → "p60Pay" (and PAYE tax → "taxTakenOff"); travel/travel warrants/vouchers → "travelVouchers"; accommodation (excluding Accommodation Expenses) → "accommodation"; Office Costs Expenditure → "officeCostsExpenditure"; contingency payment → "contingencyPayment"; Financial Assistance Fund / cash reimbursements → "financialAssistanceFund"; other benefits → "allOtherBenefits"; balancing charges → "balancingCharges"; travel warrants the member paid → "travelWarrants"; secretarial/clerical/research assistance paid → "secretarialAssistance"; office running costs paid → "officeExpenses"; other expenses and capital allowances → "otherExpensesCapitalAllowances". Leave every "parliament" field 0 if the document is not about a Westminster MP's office. Only use this for a Member of Parliament — not the Northern Ireland Assembly ("niAssembly"), a minister of religion, or ordinary employment.
...

{
  ...
  "niAssembly": { "p60Pay": number, "payrolledBenefitsStudentLoan": number, "taxTakenOff": number, "officeCostExpenditure": number, "otherCashReimbursements": number, "allOtherBenefits": number, "balancingCharges": number, "secretarialAssistance": number, "officeExpenses": number, "otherExpensesCapitalAllowances": number },
  "parliament": { "p60Pay": number, "payrolledBenefitsStudentLoan": number, "taxTakenOff": number, "travelVouchers": number, "accommodation": number, "officeCostsExpenditure": number, "contingencyPayment": number, "financialAssistanceFund": number, "allOtherBenefits": number, "balancingCharges": number, "travelWarrants": number, "secretarialAssistance": number, "officeExpenses": number, "otherExpensesCapitalAllowances": number },
  "notes": [string],
