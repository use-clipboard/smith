...
import {
  ...
  MessagesSquare, CalendarCheck, BookCopy, Clock, Landmark, ReceiptText, Megaphone, Calculator,
} from 'lucide-react';
...
export const TOOL_NAV_ITEMS: NavItem[] = [
  ...
  { moduleId: 'tax-studio',      href: '/tax-studio',      label: 'Tax Studio',      icon: Calculator, comingSoon: true },
  ...
  { moduleId: 'google-calendar', href: '/calendar',       label: 'Calendar',        icon: CalendarDays },
