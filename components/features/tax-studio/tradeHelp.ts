...
// SA103L Lloyd's Underwriters — one hint per input box.
export const LLU = {
  ukUntaxedInterest: 'Untaxed interest from UK banks/building societies, UK unit trusts and gilts held in your personal funds at Lloyd’s — amount received.',
  accruedIncomeProfits: 'Profits from the Accrued Income Scheme and deeply discounted securities.',
  ukTaxedInterest: 'Taxed interest from other UK savings and investments in your personal funds — the amount received after tax.',
  ukInterestTaxTakenOff: 'Tax taken off the taxed UK interest.',
  stockDividends: 'Stock dividends from UK companies — amount received.',
  nonQualifyingDistributions: 'Non-qualifying distributions — amount received.',
  otherUkDividends: 'Other UK dividends and qualifying distributions received in your personal funds.',
  nonUkInterestNet: 'Non-UK interest and other foreign-source income — net amount received.',
  nonUkInterestForeignTax: 'Foreign tax taken off the non-UK interest.',
  nonUkInterestUkTax: 'UK tax taken off the non-UK interest.',
  nonUkDividendsGross: 'Non-UK dividends — amount received including any dividend tax credit.',
  nonUkDividendsForeignTax: 'Foreign tax taken off the non-UK dividends.',
  nonUkDividendsUkTax: 'UK tax taken off the non-UK dividends.',
  aggregateSyndicateProfits: 'Aggregate syndicate profits from your syndicate result.',
  specialReserveWithdrawal: 'Net withdrawal or release from your Special Reserve Fund.',
  stopLossRecoveries: 'Stop loss recoveries received.',
  compensationReceipts: 'Compensation receipts.',
  foreignTaxRepayments: 'Repayments of foreign tax previously allowed as a deduction.',
  otherNonSyndicateIncome: 'Other Lloyd’s non-syndicate income.',
  ftcrGiven: 'Amount on which Foreign Tax Credit Relief was given.',
  aggregateSyndicateLosses: 'Aggregate syndicate losses from your syndicate result.',
  specialReserveTransfer: 'Net transfer to your Special Reserve Fund.',
  stopLossPremiums: 'Stop loss premiums paid.',
  quotaSharePremiums: 'Personal Quota Share and Exeat premiums paid.',
  estateProtectionPremiums: 'Estate protection plan premiums paid.',
  underwritingLoanInterest: 'Interest paid on loans taken out to fund your underwriting.',
  membersAssocExpenses: 'Lloyd’s Members’ associations expenses paid.',
  agentCommissionSalaries: 'Members’ Agent profit commission and salaries.',
  bankGuaranteeFees: 'Fees for bank guarantees / letters of credit.',
  accountancyFees: 'Accountancy fees.',
  otherExpenses: 'Other Lloyd’s expenses.',
  usIncomeTax: 'US income tax paid.',
  canadianTax: 'Canadian tax paid.',
  syndicateForeignTax: 'Syndicate foreign tax.',
  ...
  class2Voluntary: 'Tick if you choose to pay Class 2 NICs voluntarily.',
  class4Exempt: 'Tick if you are exempt from paying Class 4 NICs.',
  class4Adjustment: 'Adjustment to profits chargeable to Class 4 NICs.',
