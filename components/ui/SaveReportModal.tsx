...
interface SaveReportModalProps {
  ...
  /** Optional PDF pagination options (e.g. Performance's cover-as-own-page +
   *  margin-matched body pages). Only applied on the live-editor (paperRef) path. */
  pdfOptions?: PdfPaginationOptions;
...
export default function SaveReportModal({
  ...
  const handleSave = async () => {
    ...
    let pdfBlob: Blob;
    try {
      pdfBlob = await generatePdfBlob(reportHtml, paperRef, pdfOptions);
    } catch (err) {
      setStatus('error');
